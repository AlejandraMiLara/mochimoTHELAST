        ...
        <div className="card bg-base-100 shadow-xl overflow-hidden border-t-4 border-primary">
          ...
          <div className="card-body p-8">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
              ...
              <div
                className={`badge ${
                  statusColors[project.status] || "badge-ghost"
                } badge-lg p-4 font-bold`}
              >
                ...
                {project.tasks.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {project.tasks.map((task, idx) => (
                      <div
                        key={idx}
                        className="card bg-base-200 hover:shadow-lg transition-all duration-300 border border-base-300 overflow-hidden group"
                      >
                        <figure
                  ...
                  <div className="alert bg-base-200 border-none">
                    <span>
                      No hay imágenes de evidencia disponibles para este
                      proyecto.
                    </span>
                  </div>
                )}
                ...
                {project.requirements.length > 0 ? (
                  <ul className="space-y-2">
                    {project.requirements.map((req, idx) => (
                      <li
                        key={idx}
                        className="flex gap-3 bg-base-200/50 p-3 rounded-lg border border-base-200"
                      >
