  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        <h3 className="text-xl font-bold text-gray-900 mb-4">Solicitar Cambios</h3>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-700 transition font-medium disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
